...
function RoomDetailContent() {
    ...
    return (
        <div className="min-h-screen bg-[var(--background)] pb-24 text-[var(--text)]">
            <div className="px-5 pt-4">
                ...
                <div className="relative aspect-[4/3] w-full rounded-3xl overflow-hidden bg-gray-200 mb-6">
                    ...
                    <div className="absolute top-[20%] left-0 right-0 bottom-4 px-4 flex items-end pointer-events-none">
                        <div className="bg-white/90 backdrop-blur-md rounded-2xl p-4 w-full shadow-lg border border-white/50 pointer-events-auto flex justify-between items-center">
            ...
            {/* Bottom Bar (Fixed) */}
            <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-[var(--border)] px-5 py-4 z-50 shadow-lg">
